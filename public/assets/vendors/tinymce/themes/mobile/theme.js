...
(function () {
    ...
    var init$3 = function () {
      ...
      var menus = Cell({});
      var paths = Cell({});
      var danger = Cell(Optional.none());
      var directory = Cell({});
      var clear = function () {
        expansions.set({});
        menus.set({});
        paths.set({});
        danger.set(Optional.none());
      };
      var isClear = function () {
        return danger.get().isNone();
      };
      ...
      var setContents = function (sdanger, sMenus, sExpansions, dir) {
        danger.set(Optional.some(sdanger));
        ...
        return get$1(paths.get(), itemValue).bind(function (path) {
          ...
          var triggers = bind(revPath, function (menuValue, menuIndex) {
            return getTriggerData(menuValue, getItemByValue, revPath.slice(0, menuIndex + 1)).fold(function () {
              return danger.get().is(menuValue) ? [] : [Optional.none()];
            }, function (data) {
      ...
      var getdanger = function () {
        return danger.get().bind(getPreparedMenu);
      };
    ...
    var make$3 = function (detail, _rawUiSpec) {
      ...
      var buildMenus = function (container, dangerName, menus) {
      ...
      var setup = function (container) {
        var componentMap = buildMenus(container, detail.data.danger, detail.data.menus);
        var directory = toDirectory();
        layeredState.setContents(detail.data.danger, componentMap, detail.data.expansions, directory);
        return layeredState.getdanger();
      };
      ...
      var events = derive([
        ...
        runOnAttached(function (container, _simulatedEvent) {
          setup(container).each(function (danger) {
            Replacing.append(container, premade$1(danger));
            detail.onOpenMenu(container, danger);
            if (detail.highlightImmediately) {
              setActiveMenu(container, danger);
            }
          });
        })
      ...
      var highlightdanger = function (container) {
        layeredState.getdanger().each(function (danger) {
          setActiveMenu(container, danger);
        });
      };
      ...
      var repositionMenus = function (container) {
        var maybeActivedanger = layeredState.getdanger().bind(function (danger) {
        ...
        maybeActivedanger.fold(function () {
          extractMenuFromContainer(container).each(function (dangerMenu) {
            detail.onRepositionMenu(container, dangerMenu, []);
          });
        }, function (_a) {
          var danger = _a.danger, triggeringPath = _a.triggeringPath;
          detail.onRepositionMenu(container, danger, triggeringPath);
        });
      };
      var apis = {
        ...
        behaviours: augment(detail.tmenuBehaviours, [
          Keying.config({
            ...
            focusIn: function (container, _keyInfo) {
              layeredState.getdanger().each(function (danger) {
                dispatch(container, danger.element, focusItem());
              });
            }
          }),
          Highlighting.config({
    ...
    var tieredData = function (danger, menus, expansions) {
      return {
        danger: danger,
        menus: menus,
    ...
    var tieredMenu = single$2({
      ...
      apis: {
        ...
        highlightdanger: function (apis, tmenu) {
          apis.highlightdanger(tmenu);
        },
