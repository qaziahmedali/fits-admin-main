  ...
  dragula([document.getElementById("dragula-event-left"), document.getElementById("dragula-event-right")])
    .on('drop', function(el) {
      ...
      if (iconTochange.hasClass('ti-pin-alt')) {
        iconTochange.removeClass('ti-pin-alt text-danger').addClass('ti-time text-success');
      } else if (iconTochange.hasClass('ti-time')) {
        iconTochange.removeClass('ti-time text-success').addClass('ti-pin-alt text-danger');
      }
    })
})(jQuery);